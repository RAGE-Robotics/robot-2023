...
public class RobotState {
     ...
     * ? getCameraToTopVisionTargetTranslation(target, source.getLensHeight(),
     * source.getHorizontalPlaneToLens())
     * : getCameraToBottomVisionTargetTranslation(target, source.getLensHeight(),
     * source.getHorizontalPlaneToLens());
     * }
     * 
     * public static Translation2d getCameraToTopVisionTargetTranslation(TargetInfo
     * target, double cameraHeight,
     * Rotation2d cameraPitch) {
     * return getCameraToVisionTargetTranslation(target, cameraHeight, cameraPitch,
     * Constants.kTopVisionTargetHeight);
     * }
     * 
     * private Translation2d getCameraToBottomVisionTargetTranslation(TargetInfo
     * target, double cameraHeight,
     * Rotation2d cameraPitch) {
     * return getCameraToVisionTargetTranslation(target, cameraHeight, cameraPitch,
     * Constants.kBottomVisionTargetHeight);
     * }
     * 
     ...
     * cameraToVisionTargetTranslations,
     ...
     * Pose2d.fromTranslation(cameraToVisionTargetTranslations.get(0).interpolate(
     * cameraToVisionTargetTranslations.get(1), 0.5));
     * 
     * Pose2d fieldToVisionTarget =
     * getFieldToTurret(timestamp).transformBy(source.getTurretToLens())
     ...
     * List.of(new Pose2d(fieldToVisionTarget.getTranslation(),
     ...
     * cameraToVisionTargetTranslations.add(getCameraToVisionTargetTranslation(
     * target, source));
     * }
     * 
