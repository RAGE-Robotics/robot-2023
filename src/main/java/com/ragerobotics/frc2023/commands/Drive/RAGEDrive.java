...
public class RAGEDrive extends CommandBase {
  ...
  public void execute() {
    ...
    // wheel = handleDeadband(RobotContainer.GetTurn(), wheelDeadband);
    ...
    // double sensitivity = Constants.DriverConstants.normalTurnSensitivity;
    ...
    //   }
    // }
    // sensitivity = Constants.DriverConstants.normalTurnSensitivity;
    ...
    //   angularPower = Constants.DriverConstants.quickturnSensitivity * wheel;
    // } else {
    //   overPower = 0.0;
