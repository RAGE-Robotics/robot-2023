package com.ragerobotics.frc2023.planners;
...
public class DriveMotionPlanner implements CSVWritable {
    ...
    protected DriveOutput updatePID(DifferentialDrive.DriveDynamics dynamics, Pose2d current_state) {
        ...
        return new DriveOutput(wheel_velocities.left, wheel_velocities.right, dynamics.wheel_acceleration.left,
    ...
    protected DriveOutput updatePurePursuit(DifferentialDrive.DriveDynamics dynamics, Pose2d current_state) {
        ...
        return new DriveOutput(dynamics.wheel_velocity.left, dynamics.wheel_velocity.right,
    ...
    protected DriveOutput updateRamsete(DifferentialDrive.DriveDynamics dynamics, Pose2d current_state) {
        ...
        return new DriveOutput(dynamics.wheel_velocity.left, dynamics.wheel_velocity.right,
                dynamics.wheel_acceleration.left, dynamics.wheel_acceleration.right, feedforward_voltages.left,
    ...
    public DriveOutput update(double timestamp, Pose2d current_state) {
        ...
        if (!mCurrentTrajectory.isDone()) {
            ...
            if (mFollowerType == FollowerType.FEEDFORWARD_ONLY) {
                mOutput = new DriveOutput(dynamics.wheel_velocity.left, dynamics.wheel_velocity.right,
                        dynamics.wheel_acceleration.left, dynamics.wheel_acceleration.right, dynamics.voltage.left,
                        dynamics.voltage.right);
