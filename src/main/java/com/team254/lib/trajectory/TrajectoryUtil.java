...
public class TrajectoryUtil {
    ...
    public static <S extends IPose2d<S>, T extends IRotation2d<T>> Trajectory<TimedState<S>, TimedState<T>> mirrorTimed(
            final Trajectory<TimedState<S>, TimedState<T>> trajectory) { // todo fix
    ...
    public static Trajectory<Pose2dWithCurvature, Rotation2d> trajectoryFromWaypoints(final List<Pose2d> waypoints,
    ...
    public static Trajectory<Pose2dWithCurvature, Rotation2d> trajectoryFromSplinesAndHeadings(
            final List<? extends Spline> splines, final List<Rotation2d> headings, double maxDx, double maxDy,
            double maxDTheta) {
