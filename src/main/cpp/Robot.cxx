...
void Robot::RobotPeriodic()
{
    ...
    frc::SmartDashboard::PutNumber("X Pos", DifferentialDrivetrain::instance()->leftDistance());
    frc::SmartDashboard::PutNumber("Y Pos", DifferentialDrivetrain::instance()->rightDistance());
